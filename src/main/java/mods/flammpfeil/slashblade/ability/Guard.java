...
public class Guard {
    ...
    public void onLivingAttack(LivingAttackEvent event) {
        ...
        long timeCurrent = victim.getLevel().getGameTime();
        ...
        // damage sauce check
        // 1.19.2中移除了DamageTypeTags，因此简化判断
        ...
        if (!isJust) {
            ...
            // 1.19.2中移除了DamageTypeTags，因此注释掉这段代码
        ...
        if (victim instanceof Player) {
            victim.playSound(SoundEvents.TRIDENT_HIT_GROUND, 1.0F,
                    1.0F + victim.getLevel().getRandom().nextFloat() * 0.4F);
        }
