...
public class BladeStandEntityRenderer extends ItemFrameRenderer<BladeStandEntity> {
    ...
    private void renderItem(BladeStandEntity entity, ItemStack itemstack, PoseStack matrixStackIn,
        ...
        if (!itemstack.isEmpty()) {
            BakedModel ibakedmodel = this.itemRenderer.getModel(itemstack, entity.getLevel(), null, 0);
            net.minecraft.client.renderer.block.model.ItemTransforms.TransformType transformType = net.minecraft.client.renderer.block.model.ItemTransforms.TransformType.FIXED;
            this.itemRenderer.render(itemstack, transformType, false, matrixStackIn, bufferIn, packedLightIn,
