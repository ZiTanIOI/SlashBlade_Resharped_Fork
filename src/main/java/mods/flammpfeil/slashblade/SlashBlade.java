...
public class SlashBlade {
    ...
    public SlashBlade() {
        ...
        // SlashBladeCreativeGroup.CREATIVE_MODE_TABS.register(modEventBus); // 在1.19.2中使用旧的方式
    ...
    private void setup(final FMLCommonSetupEvent event) {
        ...
        // 注册拔刀剑注册表处理器
        mods.flammpfeil.slashblade.event.handler.SlashBladeRegistryHandler.register();

        // 注册所有内置拔刀剑定义
        mods.flammpfeil.slashblade.data.builtin.SlashBladeBuiltInRegistry.registerAll();
...
//            });
        ...
        private static ResourceLocation registerCustomStat(String name) {
            ...
            // 1.19.2中，Stats.CUSTOM是一个StatType<ResourceLocation>，不需要显式注册
